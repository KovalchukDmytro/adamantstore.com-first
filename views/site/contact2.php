		...
		<div class="row">
			...
			<div class="col-md-5 col-lg-5">
				<div class="more_contact_inf">
					...
					<div class="phone_contact_more"><a><?=$dictionary['contact_us_page']['phone_contact_more'] ?></a></div>
					<div class="email_contact_more"><?=$dictionary['contact_us_page']['email_contact_more'] ?></div>
