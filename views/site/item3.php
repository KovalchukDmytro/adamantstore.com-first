...
<section class="small_head">
	<div class="container-fluid">
		<div class="row">
			<div class="col-mini-6 col-mob-6 col-xs-4 col-sm-4">
				<div class="categories">
					<span class="fa fa-arrow-circle-left"></span> <?=$dictionary['small_head']['categories'] ?>
				</div>
			</div>
			<div class="col-mini-6 col-mob-6 col-xs-4 col-sm-4">
				<div class="products_all_1">
					<?php $br=\app\models\Brand::find()->where(['id'=>$content['model']->brand])->one();?>
					<a href="<?=$lang_url.'/'.$content['get_section'].'/'.$content['brand'].'/' ?>"> <?='"'.$br->name.'" ' ?> <?=$dictionary['small_head']['all'] ?></a>
				</div>
			</div>
	...
	<div class="container">
		...
		<div class="row product_inf">
			...
			<div class="col-md-6 padding_20">
				...
				<a class="text_decor_none" href="<?=$lang_url ?>/contact-us/"> <button class="contact_us_item_btn"><?=$dictionary['products']['contact_us_item_btn'] ?></button></a>
				<ul class="sharer">
					...
					?>
                    <li><a href="<?= $url_share?>" data-image="<?= $img_share?>" data-title="<?= $title_share?>" data-desc="S<?= $desc_share?>" class="fa fa-facebook"></a></li>
