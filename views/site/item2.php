...
<section class="products" style= "background-attachment: scroll; background-image: linear-gradient(to bottom, #0d0d0e 10%, transparent 70%), linear-gradient(to top, #0d0d0e 10%, transparent 70%), url('../../../../content_images/back/<?=$background_img->id ?>.1.b.jpg');">
	<div class="container">
		...
		<div class="row product_inf">
			...
			<div class="col-md-6 padding_20">
               <!-- <div class="logo_item"><img src="../../../../content_images/danielwellington.png"></div>-->
				<div class="full_name">
					<?=$br->name.' '.$model->mark ?>
				</div>
				<div class="short_txt">
