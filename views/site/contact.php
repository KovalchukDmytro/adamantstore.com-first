		...
		<div class="row">
			...
			<div class="col-md-5 col-lg-5">
				<div class="more_contact_inf">
					...
					<div class="phone_contact_more"><a href="tel:<?=str_replace(" ", "", $dictionary['contact_us_page']['phone_contact_more']) ?>"><?=$dictionary['contact_us_page']['phone_contact_more'] ?></a> <span class="soc_padding"><span class="fa fa-telegram"> </span><span class="fa fa-whatsapp soc_padding_1"> </span></span></div>
